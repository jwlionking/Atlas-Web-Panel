<div class="w3-container">
  ...
  <p>
    ...
    <div id="tab3div" class="w3-container info" style="display:none">
      ...
      <p><textarea rows='10' style='width:100%;' required><?php echo file_get_contents( "C:/Users/Server/Desktop/Servers/Atlas/ShooterGame/Saved/AllowedCheaterSteamIDs.txt" ); ?></textarea></p>
    </div>
